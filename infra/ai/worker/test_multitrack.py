...
def test_marks_concurrent_segments_on_cross_speaker_overlap():
    ...
    tracks = [
        {
            ...
            "segments": [
                ...
                {"start": 62.0, "end": 64.0, "text": "insieme M"},
            ],
        },
        {
            "participant_id": "a",
            ...
            "segments": [{"start": 0.0, "end": 5.0, "text": "insieme A"}],
        },
    ]
    out = merge_tracks(tracks, language="it")
    ...
    # "insieme A" (60-65) e "insieme M" (62-64) si sovrappongono → concorrenti
    assert by_text["insieme A"].get("concurrent") is True
    assert by_text["insieme M"].get("concurrent") is True
