...
.pawl {
  ...
  --panel-border: rgba(120, 180, 230, 0.22);
}
.pawl button { font-family: inherit; cursor: pointer; }
.pawl ::selection { background: rgba(54,224,255,0.3); }
...
.pawl-badge__dot { width: 10px; height: 10px; border-radius: 50%; background: #889; }
.pawl-badge--scheduled .pawl-badge__dot { background: var(--accent); }
.pawl-badge--live .pawl-badge__dot { background: #ff5470; box-shadow: 0 0 0 0 rgba(255,84,112,0.7); animation: pawl-pulse 1.6s infinite; }
.pawl-badge--ended .pawl-badge__dot { background: #9aa6b4; }
.pawl-badge__text { font-weight: 700; letter-spacing: .3px; font-size: 14px; }
.pawl-badge__count { font-size: 12px; opacity: .75; padding-left: 8px; border-left: 1px solid rgba(255,255,255,.15); }
@keyframes pawl-pulse { 0%{box-shadow:0 0 0 0 rgba(255,84,112,.6)} 70%{box-shadow:0 0 0 9px rgba(255,84,112,0)} 100%{box-shadow:0 0 0 0 rgba(255,84,112,0)} }
...
.pawl-dock__label { font-size: 11px; text-transform: uppercase; letter-spacing: .6px; opacity: .65; }
.pawl-input {
...
.pawl-input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(54,224,255,.18); }
...
.pawl-toggle {
  ...
  background: rgba(255,255,255,0.05); color: #dce8f5;
}
.pawl-toggle--on { background: rgba(54,224,255,0.16); border-color: var(--accent); color: #fff; }
...
.pawl-select {
  ...
  background: rgba(255,255,255,0.07); border: 1px solid var(--panel-border); color: #fff;
}
...
.pawl-btn {
  ...
  background: linear-gradient(180deg, #3fe0ff, #15b6e6); color: #04222e;
  transition: filter .15s, opacity .15s;
}
.pawl-btn:hover { filter: brightness(1.06); }
.pawl-btn:disabled { background: #3a4658; color: #8a98ab; cursor: not-allowed; }
.pawl-config__note { font-size: 11px; opacity: .6; text-align: center; margin-top: 8px; }
...
.pawl-onb__card {
  ...
  background: var(--panel); border: 1px solid var(--panel-border);
  border-radius: 18px; box-shadow: 0 24px 60px rgba(0,0,0,0.6); text-align: center;
}
...
.pawl-key kbd {
  ...
  padding: 3px 6px; border-radius: 6px; background: rgba(255,255,255,.1);
  border: 1px solid rgba(255,255,255,.2); box-shadow: 0 2px 0 rgba(0,0,0,.3);
}
.pawl-onb__btn {
...
.pawl-info {
  ...
  background: var(--panel); border: 1px solid var(--panel-border); color: #eaf2fb;
...
.pawl-joy__thumb {
  ...
  background: rgba(54,224,255,0.55); border: 2px solid #cdeffb; transform: translate(-50%,-50%);
}
...
.pawl-top-btn {
  pointer-events: auto; font-family: inherit; font-size: 13px; font-weight: 700; color: #eaf2fb;
  padding: 9px 14px; border-radius: 999px; border: 1px solid var(--panel-border);
  background: var(--panel); backdrop-filter: blur(8px); box-shadow: 0 6px 18px rgba(0,0,0,.3);
...
.pawl-top-btn--primary {
  background: linear-gradient(180deg, #3fe0ff, #15b6e6); color: #04222e; border: 0;
...
.pawl-onb__name {
  ...
  background: rgba(255,255,255,.08); color: #fff; font-size: 16px; outline: none; margin-bottom: 14px;
}
.pawl-onb__name:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(54,224,255,.2); }
